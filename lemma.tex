...
\usepackage[paperwidth=150cm,paperheight=30cm, margin=5mm]{geometry}
...
\inferrule
{
    \inferrule
    {
      ...
      {\inferrule
        ...
        \\
      \inferrule
        {\inferrule{TODO~m \\ TODO~n}{\Gamma,\, m\!:\!\N,\, n\!:\!\N \d (m+n) : \N}}
        {\Gamma, m\!:\!\N, n\!:\!\N \vdash \s(m\!+\!n) : \N}
      }
      {\Gamma,\, m : \N,\, n : \N \d (\s(m) + n = \s(m+n)) \type} \\
    \inferrule
      {\inferrule{\inferrule{TODO'~m}{\Gamma, m\!:\!\N \d m\!+\!\.0 \equiv m : \N}}{\Gamma, m\!:\!\N \d m \equiv m\!+\!\.0 : \N} \\ 
	{\inferrule
    ...
    \inferrule {\inferrule
      {\inferrule
        {\inferrule
           {\inferrule{TODO~\s(m) \\ TODO~\s(n)}{\Gamma, m\!:\!\N, n\!:\!\N \vdash (\s(m)\!+\!\s(n))\!: \N} \\ \inferrule{TODO}{\Gamma, m\!:\!\N, n\!:\!\N \vdash \s(m\!+\!\s(n))\.\!: \N}}
           {\Gamma,\, m : \N,\, n : \N \d (\s(m) + \s(n) = \s(m+\s(n))) \type}
         \\ \inferrule
           {\inferrule
             {\inferrule{\inferrule{TODO~m \\ TODO~n}{\Gamma,\, m\!:\!\N,\, n\!:\!\N \d m+\s(n) \equiv \s(m\!+\!n) : \N}}{\Gamma,\, m\!:\!\N,\, n\!:\!\N \d \s(m\!+\!n) \equiv m+\s(n) : \N}}
