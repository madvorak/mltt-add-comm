...
\usepackage[paperwidth=240cm,paperheight=20cm, margin=5mm]{geometry}
    ...
    \inferrule {\inferrule
      {\inferrule
        ...
        {\inferrule{\inferrule
          ...
          {\Gamma,\, m\!:\!\N,\, n\!:\!\N \d n\!:\!\N}
          W}{\Gamma,\, m\!:\!\N,\, n\!:\!\N \d (m+n) : \N} \\ \inferrule{\inferrule{~}{\Gamma \vdash \N \type} \\ \inferrule{\inferrule{~}{\Gamma \vdash \N \type} \\ \inferrule{\inferrule{~}{\Gamma \d \s : \N \r \N}}{\Gamma,\, r\!:\!\N \d \s(r) : \N}\,\textup{ev}}{\Gamma,\, n\!:\!\N,\, r\!:\!\N \d \s(r) : \N}W}{\Gamma,\, m\!:\!\N,\, n\!:\!\N,\, r\!:\!\N \d \s(r) : \N}W}
        {\Gamma,\, m\!:\!\N,\, n\!:\!\N \d \s(m + n) : \N}S \\ \inferrule {\inferrule {\inferrule
                 {\inferrule{~}{\Gamma \vdash \N \type} \\ \inferrule{\inferrule{~}{\Gamma \vdash \N \type} \\ \inferrule{\inferrule{~}{\Gamma \d \s : \N \r \N}}{\Gamma,\, m\!:\!\N \d \s : \N \r \N}\,W}{\Gamma,\, m\!:\!\N,\, n\!:\!\N \d \s : \N \r \N}W}
      ...
      }{\Gamma,\, m : \N,\, n : \N \;\d\; \apply_{\s}(\s(m)\!+\!n, \s(m\!+\!n)) \::\: \s(m) + n = \s(m+n) \rightarrow \s(m) + \s(n) = \s(m+\s(n))}\eta~TODO}
