...
\usepackage[a0paper, landscape, margin=5mm]{geometry}
    ...
    \inferrule {\inferrule
      {\inferrule
        ...
        \inferrule
          {\inferrule{~}{\Gamma \vdash \N \type} \\ \inferrule{\inferrule{~}{\Gamma \vdash \N \type}}{\Gamma, n\!:\!\N \vdash n\!:\!\N}\delta}
          {\Gamma,\, m\!:\!\N,\, n\!:\!\N \d n\!:\!\N}
          W}{\Gamma,\, m\!:\!\N,\, n\!:\!\N \d (\s(m)\!+\!n)\!: \N} \\ \inferrule {\inferrule{\Gamma,\, m\!:\!\N,\, n\!:\!\N \d (m\!+\!n)\!: \N}{\Gamma, m\!:\!\N, n\!:\!\N \vdash \s(m\!+\!n)\!: \N} \\ \inferrule {\inferrule {\inferrule
